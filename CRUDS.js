document.addEventListener('DOMContentLoaded', function() {
    ...
    function showdata() {
        ...
        let btndel=document.getElementsByName('all');
    ...
    // 0000000000000000000 Initialiser la table 00000000000000000000000000000
    showdata();
    ...
    // !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!  delete all   !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
            ...
            /*for(i=1;i<dataprod.length;i++){
            dataprod.splice(i);
            localStorage.setItem( 'produc', JSON.stringify(dataprod));
            showdata();
        }}
        else{
